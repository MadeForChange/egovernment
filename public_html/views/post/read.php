...
<div class="row">
	...
	<div class="col-md-9">
		...
		<p class="footer">
			...
			<?php if($q->user_id != $current_user->id) { ?><a href="#me" class="btn btn-sm btn-default <?php echo $upvote_class; ?>" name="<?php echo $q->id; ?>" value="<?php echo $q->likes; ?>" data-obj="question" data-lbl="<?php echo $lang['btn-like']; ?>" data-lbl-active="<?php echo $lang['btn-liked']; ?>"  ><i class="fa fa-thumbs-o-up"></i> <?php echo $lang['btn-likes']; ?> | <?php echo $q->likes; ?></a>
			<a href="#me" class="btn btn-sm btn-default <?php echo $downvote_class; ?>" name="<?php echo $q->id; ?>" value="<?php echo $q->dislikes; ?>" data-obj="question" data-lbl="<?php echo $lang['btn-dislike']; ?>" data-lbl-active="<?php echo $lang['btn-disliked']; ?>"  ><i class="fa fa-thumbs-o-down"></i> <?php echo $lang['btn-dislikes']; ?> | <?php echo $q->dislikes; ?></a><?php } else { ?>
			
			<a href="#me" class="btn btn-sm btn-default disabled" ><i class="fa fa-thumbs-o-up"></i> <?php echo $lang['btn-likes']; ?> | <?php echo $q->likes; ?></a>
			<a href="#me" class="btn btn-sm btn-default disabled" ><i class="fa fa-thumbs-o-down"></i> <?php echo $lang['btn-likes']; ?> | <?php echo $q->dislikes; ?></a>
			
			<?php } if($current_user->can_see_this("answers.create",$group)) { ?><a href="#me" id="answer-btn" class="btn btn-sm btn-default"><i class="fa fa-comments"></i> <?php echo $lang['btn-answers']; ?> | <?php echo $q->answers; ?></a><?php } ?>
			<a href="#me" class="btn btn-sm btn-default"><i class="fa fa-eye"></i> <?php echo $lang['btn-views']; ?> | <?php echo $q->views; ?></a>
						  ...
						  <div class="modal-body">
								<div class="form-group">
									<div class="flag_reasons clearfix">
										...
										<div class="radio">
										  <label>
											<input type="radio" name="info" id="optionsRadios1" value="<?php echo $reason; ?>">
		...
		<p class="publisher">
			...
			<p class="name">
				...
				<b><a href="<?php echo $url_mapper['users/view'] . $q->user_id; ?>/" style="color:black"><?php echo $user->f_name . " " . $user->l_name; ?></a></b><?php if($user->last_seen >= (time() - 300000)) { echo "&nbsp;<i class='text-success fa fa-circle'></i>"; } ?><?php if($user->comment) { echo " " . $user->comment; } ?>
				...
				<a href="#me" class="btn btn-sm btn-default open-chat" data-user_id="<?php echo $user->id; ?>" ><i class="fa fa-comments-o"></i> <?php echo $lang['index-chat-title']; ?></a>
				<?php } ?>
				
				<?php } ?>
				
				<br><small style="color:#999"><?php if(!$q->anonymous) { ?> @<?php echo $user->username; ?> | <?php } if($q->updated_at != "0000-00-00 00:00:00") { echo $lang['index-question-updated'] . ' ' . date_ago($q->updated_at); } else { echo $lang['index-question-created'] . ' ' . date_ago($q->created_at); }?></small>
		...
		<div class="publisher">
			...
			<img src="<?php echo $quser_avatar; ?>" class="img-circle" style="float:<?php echo $lang['direction-left']; ?>;width:46px;margin-<?php echo $lang['direction-right']; ?>:10px">
			<p class="name">
				<b><a href="<?php echo $url_mapper['users/view'] . $a->user_id; ?>/"><?php echo $user->f_name . " " . $user->l_name; ?></a></b><?php if($user->last_seen >= (time() - 300000)) { echo "&nbsp;<i class='text-success fa fa-circle'></i>"; } ?><?php if($user->comment) { echo " " . $user->comment; } ?>
		...
		<p class="footer">
			...
			<div class="btn-group question-like-machine">
				<a href="#me" class="btn btn-sm btn-default  answer_comment" data-answer_id="<?php echo $a->id; ?>" ><i class="fa fa-comment"></i> <?php echo $lang['btn-reply']; ?></a>
				<?php if($a->user_id != $current_user->id) { ?><a href="#me" class="btn btn-sm btn-default <?php echo $upvote_class; ?>" name="<?php echo $a->id; ?>" value="<?php echo $a->likes; ?>" data-obj="answer" data-lbl="" data-lbl-active="" ><i class="fa fa-thumbs-o-up"></i> | <?php echo $a->likes; ?></a>
				<a href="#me" class="btn btn-sm btn-default <?php echo $downvote_class; ?>" name="<?php echo $a->id; ?>" value="<?php echo $a->dislikes; ?>" data-obj="answer" data-lbl="" data-lbl-active="" ><i class="fa fa-thumbs-o-down"></i> | <?php echo $a->dislikes; ?></a><?php } else { ?>
				
				<a href="#me" class="btn btn-sm btn-default disabled" ><i class="fa fa-thumbs-o-up"></i> <?php echo $lang['btn-likes']; ?> | <?php echo $a->likes; ?></a>
				<a href="#me" class="btn btn-sm btn-default disabled" ><i class="fa fa-thumbs-o-down"></i> <?php echo $lang['btn-dislikes']; ?> | <?php echo $a->dislikes; ?></a>
				<?php } ?>
				<div class="btn-group">
					<button type="button" class="btn btn-sm btn-default dropdown-toggle" data-toggle="dropdown">
					<?php echo $lang['btn-tools']; ?> <span class="caret"></span></button>
		...
		if($sub_answers) {
			foreach($sub_answers as $sa) {
				
			if($sa->published == '1' || $sa->published == '0' && $current_user->id == $sa->user_id || $sa->published == '0' && $current_user->prvlg_group == '1' ) {
				
				$user = User::get_specific_id($sa->user_id);
				if($user->avatar) {
					$img = File::get_specific_id($user->avatar);
					$quser_avatar = WEB_LINK."public/".$img->image_path();
					$quser_avatar_path = UPLOAD_PATH."/".$img->image_path();
				...
				$upvote_txt = '';
				$liked = LikeRule::check_for_obj('answer' , "like" , $sa->id, $current_user->id);
				if($liked) {
					$upvote_txt = '';
					$upvote_class = 'active undo-upvote';
					$downvote_class = 'downvote disabled';
				...
				$downvote_txt = '';
				$disliked = LikeRule::check_for_obj('answer' , "dislike" , $sa->id, $current_user->id);
				if($disliked) {
					$downvote_txt = '';
					$upvote_class = 'upvote disabled';
					$downvote_class = 'active undo-downvote';
		...
		<div class="question-element"  style="margin-<?php echo $lang['direction-left']; ?>: 50px" id="answer-<?php echo $sa->id; ?>">
		<div class="publisher">
			<?php if($sa->published == 0) { ?><p class="label label-danger"><i class="fa fa-eye-slash"></i> <?php echo $lang['questions-pending-tag']; ?></p><?php } ?>
			<img src="<?php echo $quser_avatar; ?>" class="img-circle" style="float:<?php echo $lang['direction-left']; ?>;width:46px;margin-<?php echo $lang['direction-right']; ?>:10px">
			<p class="name">
				<b><a href="<?php echo $url_mapper['users/view'] . $sa->user_id; ?>/"><?php echo $user->f_name . " " . $user->l_name; ?></a></b><?php if($user->last_seen >= (time() - 300000)) { echo "&nbsp;<i class='text-success fa fa-circle'></i>"; } ?><?php if($user->comment) { echo " " . $user->comment; } ?>
				
				<?php if($sa->user_id != $current_user->id && $current_user->can_see_this('users.follow' , $group) ) { ?>
				<?php
				$u_follow_class = 'follow';
				$follow_txt = $lang['btn-follow'];
				$followed = FollowRule::check_for_obj('user' , $user->id, $current_user->id);
				...
				<?php } ?>
				<br><small>@<?php echo $user->username; ?> | <?php if($sa->updated_at != "0000-00-00 00:00:00") { echo $lang['index-question-updated'] . ' ' . date_ago($sa->updated_at); } else { echo $lang['index-question-created'] . ' ' . date_ago($sa->created_at); }?></small>
			</p>
		</div><br>
		<p class="question-content">
			<?php $content = str_replace('\\','',$sa->content);
				$content = str_replace('<script','',$content);
				$content = str_replace('</script>','',$content);
				echo profanity_filter($content); ?>
		</p>
		...
		<p class="footer">
			...
			<div class="btn-group question-like-machine">
				...
				<?php if($sa->user_id != $current_user->id) { ?><a href="#me" class="btn btn-sm btn-default <?php echo $upvote_class; ?>" name="<?php echo $sa->id; ?>" value="<?php echo $sa->likes; ?>" data-obj="answer" data-lbl="" data-lbl-active="" ><i class="fa fa-thumbs-o-up"></i> | <?php echo $sa->likes; ?></a>
				<a href="#me" class="btn btn-sm btn-default <?php echo $downvote_class; ?>" name="<?php echo $sa->id; ?>" value="<?php echo $sa->dislikes; ?>" data-obj="answer" data-lbl="" data-lbl-active="" ><i class="fa fa-thumbs-o-down"></i> | <?php echo $sa->dislikes; ?></a><?php } else { ?>
				
				<a href="#me" class="btn btn-sm btn-default disabled" ><i class="fa fa-thumbs-o-up"></i> <?php echo $lang['btn-likes']; ?> | <?php echo $sa->likes; ?></a>
				<a href="#me" class="btn btn-sm btn-default disabled" ><i class="fa fa-thumbs-o-down"></i> <?php echo $lang['btn-dislikes']; ?> | <?php echo $sa->dislikes; ?></a>
				<?php } ?>
				<div class="btn-group">
					<button type="button" class="btn btn-sm btn-default dropdown-toggle" data-toggle="dropdown">
					<?php echo $lang['btn-tools']; ?> <span class="caret"></span></button>
					<ul class="dropdown-menu" role="menu" style="width:100px; background-color:white">
						<?php if($sa->user_id == $current_user->id || $current_user->prvlg_group == '1') { ?>
							<?php if($sa->published == 0) { ?>
							<?php if($current_user->can_see_this('pending.update' , $group)) { ?>
							<li><a href="<?php echo $url_mapper['answers/approve'] . $url_type . "&type=approve_answer&id={$sa->id}&hash={$random_hash}"; ?>" >Approve Answer</a></li>
							<li role="separator" class="divider"></li>
							<?php } ?>
							<?php } ?>
						
							<?php if($current_user->can_see_this('answers.update' , $group)) { ?><li><a href="<?php echo $url_mapper['answers/edit'] . $url_type; ?>&type=edit_answer&id=<?php echo $sa->id; ?>&hash=<?php echo $random_hash; ?>#answer-question" >Edit</a></li><?php } ?>
							<?php if($current_user->can_see_this('answers.delete' , $group)) { ?><li><a href="<?php echo $url_mapper['answers/delete'] . $url_type; ?>&type=delete_answer&id=<?php echo $sa->id; ?>&hash=<?php echo $random_hash; ?>" onclick="return confirm('Are you sure you want to delete this answer?');">Delete</a></li><?php } ?>
						
						<li role="separator" class="divider"></li>
						<?php } ?>
						<?php $reported = Report::check_for_obj('answer' , $sa->id, $current_user->id); ?>
						<?php if(!$reported) { ?>
						<li><a href="#report-a-<?php echo $sa->id; ?>" data-toggle="modal" ><?php echo $lang['questions-answer-report']; ?></a></li>
						<?php } else { ?>
						<li style='color:#a0a0a0; text-align:center; padding:5px'><?php echo $lang['questions-report-reported']; ?></li>
						<?php } ?>
					</ul>
					...
					<?php if(!$reported) { ?>
					<!-- Modal -->
					<div class="modal fade in" id="report-a-<?php echo $sa->id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					  <div class="modal-dialog modal-lg" role="document">
						<div class="modal-content">
						  <div class="modal-header">
							<h5 class="modal-title" id="exampleModalLabel"><?php echo $lang['questions-answer-report']; ?></h5>
						  ...
						  <div class="modal-footer">
							...
							<?php 
								$_SESSION[$elhash] = $random_hash;
								echo "<input type=\"hidden\" name=\"hash\" value=\"".$random_hash."\" readonly/>";
								echo "<input type=\"hidden\" name=\"id\" value=\"".$sa->id."\" readonly/>";
								echo "<input type=\"hidden\" name=\"obj_type\" value=\"answer\" readonly/>";
							?>
						  </form>
						</div>
		...
		<div class="pagination btn-group">
				...
				echo " <a href=\"{$page_param}\" class=\"btn btn-default\" type=\"button\"><i class=\"fa fa-chevron-{$lang['direction-right']}\"></i></a> ";
				} else {
				?>
		...
		<div class="col-md-12" style='margin-top:-100px;padding:0'>
			<a href="<?php echo $url_mapper['login/']; ?>"><img src="<?php echo WEB_LINK; ?>/public/img/login-notice.png" style='width:100%'></a>
	...
	<div class="col-md-3 hidden-sm hidden-xs">
		...
		<i class="fa fa-exclamation-triangle"></i>&nbsp;&nbsp;<?php echo $lang['index-sidebar-related_questions']; ?>
		<hr>
			...
			<?php 
				...
				if($answers) {
					foreach($answers as $a) {
						...
						?>
						<li><a href="<?php echo $url_mapper['questions/view']; echo $url_type2; ?>#answer-<?php echo $a->id; ?>" class="col-md-12"><?php echo $string; ?></a></li>
						<?php
					}
				if($total_count > 5) {
				?>
	...
	$(document).ready(function(){
		$("img[id != 'site-logo']").addClass("img-responsive");
	});
