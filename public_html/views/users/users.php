...
<div class="row">
	...
	<div class="col-md-2 ">
		...
		<i class="fa fa-question-circle"></i>&nbsp;&nbsp;<?php echo $lang['user-sections']; ?>
		<hr>
		<ul class="feed-ul">
	...
	<div class="col-md-8">
		...
		<div class="publisher" style="margin-top:20px">
			<p class="name" style="font-size:25px">
				<b><?php echo $user->f_name . " " . $user->l_name; ?></b><?php if($user->last_seen >= (time() - 300000)) { echo "&nbsp;<i class='text-success fa fa-circle'></i>"; }  echo "&nbsp;<a href='".WEB_LINK."/rss/user/".$user->id."' target='_blank'><img src='".WEB_LINK."/public/img/rss.png' style='width:25px'></a>&nbsp;"; ?>
		...
		?>
				<div class="question-element">
					...
					<?php if($current_user->can_see_this('questions.interact' ,$group)) { ?><p class="footer question-like-machine">
						<a href="<?php echo $url_mapper['questions/view'] . $url_type; ?>#answer-question" class="btn btn-default"><i class="fa fa-pencil"></i> <?php echo $lang['index-question-answer']; if($q->answers) {  echo " | {$q->answers}"; } ?></a>
		...
		?>
				<div class="question-element">
					...
					<p class="footer">
						...
						<a href="<?php echo "{$url_mapper['questions/view']}{$url_type}#answer-{$a->id}"; ?>" class="btn btn-sm btn-default" target="_blank"><i class="fa fa-search"></i></a>
						...
						<a href="#me" class="btn btn-sm btn-default <?php echo $downvote_class; ?>" name="<?php echo $a->id; ?>" value="<?php echo $a->dislikes; ?>" data-obj="answer" data-lbl="" data-lbl-active="" ><i class="fa fa-thumbs-o-down"></i> | <?php echo $a->dislikes; ?></a><?php } ?>
						<div class="btn-group">
	...
	<div class="col-md-2">
		<i class="fa fa-lock"></i>&nbsp;&nbsp;<?php echo $lang['user-account-options']; ?>
		<hr>
		<ul class="feed-ul">
