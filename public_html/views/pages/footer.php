<?php if($chat->value=='on'  && $current_user->id != '1000' ) {  include_once(VIEW_PATH.'pages/chat.php'); } ?>
<br><br><div class="master-footer pull-<?php echo $lang['direction-right']; ?>">
	...
	<a href="https://pleasezoom.in" target="_blank">Please Zoom In </a>&copy; 2020
</div>	
