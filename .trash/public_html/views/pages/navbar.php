<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" style="z-index:1112 !important">
      <div class="container">
		...
		<ul class="nav navbar-nav navbar-<?php echo $lang['direction-right']; ?>" >
            <li <?php if($navsec == 'index') { echo ' class="current" '; } ?>><a href="<?php echo $url_mapper['index/']; ?>"><i class="fa fa-list-alt"></i>&nbsp;&nbsp;<?php echo $lang['index-read-button']; ?></a></li>
            <?php if($current_user->can_see_this('index.notifications', $group)) { ?><li class="dropdown ">
				<a href="<?php echo $url_mapper['notifications/']; ?>" data-toggle="dropdown" data-hover="dropdown" data-close-others="true" <?php if($navsec == 'notifications') { echo ' class="current" '; } ?> ><i class="fa fa-bullhorn"></i>&nbsp;&nbsp;<?php echo $lang['index-notification-button'];
				...
				<ul class="dropdown-menu" >
					...
					<ul class="dropdown-menu-list withScroll menu-ajax-receptor" data-height="220" style="width:400px;list-style-type:none;cursor:pointer">
						...
						?>
						<h3 style="color:#b0b0b0"><center><i class="fa fa-bullhorn"></i><br><?php echo $lang['index-notification-no_notifications']; ?></center></h3><br><br>
						<?php } ?>
					</ul>
				</ul>
				
			</li><?php } ?>
			<?php if($current_user->can_see_this('admin.read', $group)) { ?><li <?php if($navsec == 'admin') { echo ' class="current" '; } ?> ><a href="<?php echo $url_mapper['admin/']; ?>"><i class="fa fa-wrench"></i>&nbsp;&nbsp;<?php echo $lang['index-admin-button']; ?></a></li> <?php } ?>
			<?php 
			
			if($current_user->id == '1000') {
				$user_avatar = WEB_LINK.'public/img/avatar.png';
			?>
				<li><a href="<?php echo $url_mapper['login/']; ?>"><i class="fa fa-power-off"></i>&nbsp;&nbsp;<?php echo $lang['index-user-login']; ?></a></li>
			<?php
			} else {
				//global user avatar
			...
			<li><a href="<?php echo $url_mapper['pages/view']; ?>about_us" class="visible-xs"><i class="fa fa-question-circle"></i>&nbsp;&nbsp;<?php echo $lang['pages-about-title']; ?></a></li>
			<li><a href="<?php echo $url_mapper['pages/view']; ?>contact_us" class="visible-xs"><i class="fa fa-comments-o"></i>&nbsp;&nbsp;<?php echo $lang['pages-contact-title']; ?></a></li>
	...
	if(file_exists(UPLOAD_PATH.'/../install/index.php')) {
