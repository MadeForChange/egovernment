...
<div class="row">
	...
	<div class="posts_container col-md-8" style="overflow:hidden">
		...
		?>
			...
			<small><a href="<?php echo $url_mapper['notifications/']."&hash={$random_hash}&type=read_all"; ?>" class="btn btn-primary  pull-<?php echo $lang['direction-right']; ?>"><?php echo $lang['pages-notifications-read_all']; ?></a></small>
			</h3>
			<?php 
				...
				?>
				<h3 style="color:#b0b0b0"><center><i class="fa fa-bullhorn"></i><br><?php echo $lang['index-notification-no_results']; ?></center></h3><br><br>
				<?php } ?>
...
$(document).ready(function() {
	...
	win.scroll(function() {
		...
		if ($(document).height() - win.height() == win.scrollTop() ) {
			...
			if(page) {
				$('#loading_wrap').show();
				$.post("<?php echo WEB_LINK; ?>public/includes/one_ajax.php?type=index_posts", {id: <?php echo $current_user->id; ?> , data: page , query: "<?php echo $query; ?>" , hash:'<?php echo $random_hash; ?>'}, function(data){ $(".posts_container").append(data); $("#loading_wrap").hide(); });
