...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="<?php echo WEB_LINK; ?>public/css/bootstrap.css?v=1.01" rel="stylesheet">
	...
	<link href="<?php echo WEB_LINK; ?>public/plugins/typeahead/typeaheadjs.css?v=1.01" rel="stylesheet">
...
<div class="row">
	...
	<div class="col-md-8">
		...
		<br><br><br>
		<center><img src="<?php echo WEB_LINK; ?>public/img/closed.png" style='width:150px' ><br>
