...
$('.question-like-machine').on('click' , '.upvote' , function() {
	...
	$(this).html('<i class="fa fa-thumbs-o-up"></i> ' + $(this).data('lbl-active') + ' | ' + count);
...
$('.question-like-machine').on('click' , '.undo-upvote' , function() {
	...
	count--;
	$(this).attr('value', count);
	$(this).html('<i class="fa fa-thumbs-o-up"></i> ' + $(this).data('lbl') + ' | ' + count);
...
$('.question-like-machine').on('click' , '.downvote' , function() {
	...
	count++;
	$(this).attr('value', count);
	$(this).html('<i class="fa fa-thumbs-o-down"></i> ' + $(this).data('lbl-active') + ' | ' + count);
...
$('.question-like-machine').on('click' , '.undo-downvote' , function() {
	...
	count--;
	$(this).attr('value', count);
	$(this).html('<i class="fa fa-thumbs-o-down"></i> ' + $(this).data('lbl') + ' | ' + count);
