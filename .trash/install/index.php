    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
		...
		<ul class="nav navbar-nav navbar-right">
            <li class='current'><a href="#me"><i class="fa fa-power-off"></i>&nbsp;&nbsp;Install</a></li>
			  ...
			  <div class="modal-dialog" role="document">
				<div class="modal-content">
				  ...
				  <div class="modal-body">
					...
					<pre><?php echo $url2 . '/public/hybridauth/?hauth.done=Google' ."<br>". $url . 'public/hybridauth/?hauth.done=Google'; ?></pre>
					<br>
