...
class Answer Extends OneClass {
	...
	public static $db_fields = array( "id" , "user_id" , "q_id" , "a_id", "content", "likes", "dislikes", "created_at" , "updated_at" , "published");
	...
	global $db;
	$result_array =  static::preform_sql("SELECT * FROM " . DBTP . self::$table_name . " WHERE q_id = " . $q_id . " AND a_id = 0 AND published = 1 ORDER BY likes DESC LIMIT 1");
